# -*- encoding: utf-8 -*-
# stub: activesupport 7.1.4.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v7.1.4.1/activesupport/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v7.1.4.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v7.1.4.1/activesupport" } if s.respond_to? :metadata=
